...
val SKIP_SIGN = System.getenv("SKIP_SIGN") ?: project.findProperty("SKIP_SIGN") as? String ?: "false"
check(APP_VERSION.startsWith("v")) {
    "APP_VERSION not supported, current is $APP_VERSION"
}

check(SKIP_SIGN.toBooleanStrictOrNull() != null) {
    "SKIP_SIGN not supported, current is $SKIP_SIGN"
}

if (SKIP_SIGN.toBooleanStrict()) {
    println("SKIP SIGN was enabled")
}
